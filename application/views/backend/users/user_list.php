            ...
            <tbody>
               ...
               <td> 
                 <div class="" style="position: relative;">     
						      <input type="text" name="name" id="usernameSearch" placeholder="Username" value="<?php if(isset($_GET['name']))echo $_GET['name'];?>" class="form-control" autocomplete="off">
               ...
               <td width="110"> 
                  ...
                  <a class="btn btn-danger tooltips" rel="tooltip" data-placement="top" data-original-title="Reset Search" type="submit" href="<?php echo base_url('backend/users'); ?>"> <i class="icon icon-refresh"></i></a>
               </td>
               </tr> 
              </tbody>
            </table>
         ...
         <tbody>
          <form class="formid" action="<?php echo current_url(); ?>" method="post" >
            ...
            <?php  
             ...
             // if($row->favorite_incredible_places_id==''):
            ?>
            <tr>
               <td>
                  <span class="checkboxli term-check">
               ...
               <td>#&nbsp;<?php echo $row->user_id ?>
                ...
                <td>
                 <a href="<?php echo base_url();?>backend/users/edit_user/<?php echo $row->user_id.'?user_type=1';?>"><?php $first_name = ucfirst($row->first_name); $last_name = ucfirst($row->last_name);echo $first_name.' '.$last_name ?></a>
                </td>
               ...
               <td>
                <a href="<?php echo base_url().'backend/users/edit_user/'.$row->user_id.'?user_type=1'?>" class="btn btn-primary btn-xs tooltips" rel="tooltip" data-placement="top" data-original-title=" View <?php //echo ucwords($row->name); ?>"><i class="fa fa-eye"></i>
                  </a>
            ...
            <tr>
               <th colspan="9">
                 <center> <img src="<?php echo base_url('/assets/backend/admin/images/empty-item.png'); ?>"></center>
                  <center>No User's Available.</center>
               </th>
            </tr>
            ...
            <?php }
              ...
              <tr>
               <th colspan='9'>
                  ...
                  <center>User's are not available related to your search.</center> -->
...
<script>
   ...
   jQuery(document).ready(function($) {
    ...
    $("#usernameSearch").keyup(function () {
        ...
        $.ajax({
            type: "POST",
            url :'<?php echo base_url() ?>'+'backend/users/username_search',
            data: {
