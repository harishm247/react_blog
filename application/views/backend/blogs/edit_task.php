   ...
   <div class="panel-body">
      <form role="form" class="form-horizontal tasi-form" action="<?php echo current_url()?>" enctype="multipart/form-data" method="post">
            ...
            <div class="col-md-9">
               <select class="form-control" name="project_id" disabled>
				  ...
				  <?php echo set_select('project_id',$project->id);?> 
				   <?php if($tasks->project_id==$project->id) echo 'selected';?> >
         ...
         <div class="form-group">
            ...
            <div class="col-md-9">
               <input type="text" placeholder="Task" class="form-control" name="task" value="<?php echo $tasks->task//set_value('task');?>" disabled> <span class="error"><?php echo form_error('task'); ?> </span>
            </div>
         </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
               <select class="form-control" name="user_id" >
                  ...
                  <option value="<?php echo $user->user_id;?>"  <?php echo set_select('user',$user->user_id);?> 
				  <?php if($tasks->user_id==$user->user_id) echo 'selected';?>>
		 ...
		 <?php } ?>
		 <?php $status= array('To do','In progress','Done'); ?>
         <div class="form-group">
            ...
            <div class="col-md-9">
               <select class="form-control" name="status" >
                  ...
                  <option value="<?php echo $key;?>"  <?php echo set_select('status',$key);?> 
				  <?php if($tasks->status==$key) echo 'selected';?>>
         ...
         <div class="form-actions fluid">
            <div class="col-md-offset-2 col-md-10">
               ...
               <a class="btn btn-danger" href="<?php echo base_url()?>backend/tasks/index">
               Cancel</a>
            </div>
         </div>
      </form>
